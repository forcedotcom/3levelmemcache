...
public class MemcachedClientFactoryBean {
    ...
    private static Log log = LogFactory.getLog(MemcachedClientFactoryBean.class);
    ...
    public MemcachedClientIF getObject() throws Exception {
        try {
            ...
            connectionFactoryBuilder.setHashAlg(CouchbaseConnectionFactory.DEFAULT_HASH);
            
            connectionFactoryBuilder.setOpQueueFactory(new CustomQueueFactory(queueSize));
            ...
            log.error("Can't connect to membase baseList:" + baseList + ", bucketName:"
                    + bucketName);
    ...
    protected CouchbaseClient getCouchBaseConnection(
        ...
        CouchbaseClient couchbaseClient = new CouchbaseClient(
                connectionFactoryBuilder.buildCouchbaseConnection(baseList, bucketName,
                        StringUtils.EMPTY));
